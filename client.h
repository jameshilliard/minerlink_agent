...
char *command_code[COMMAND_SUM]={"10","20","30","40","50","60","70"};//after switch/reply
...
#define DATAFORMAT_CONF_PAHT "/home/fyw/config/dataformatconfig/"
char *bb_black_conf_dir="/home/fyw/config/minermonitor.conf";
char *bb_black_cgc_dir = "/config/cgminer.conf";
char *command_code[COMMAND_SUM]={"10","20","30","40","50","60","70"};//after switch
char *server_command_code[COMMAND_SUM]={"01","02","03","04","05","06","07"};//source command code from server
char *server_command[COMMAND_SUM]={"AUTH","devs","summary","stats","pools","","lcd"};
char *dataformat_conf_dir[COMMAND_SUM]={"",DATAFORMAT_CONF_PAHT"dataformat_devs.conf",DATAFORMAT_CONF_PAHT"dataformat_summary.conf",DATAFORMAT_CONF_PAHT"dataformat_stats.conf",DATAFORMAT_CONF_PAHT"dataformat_pools.conf","",DATAFORMAT_CONF_PAHT"dataformat_lcds.conf"};
char *pid_lock_dir = "/home/fyw/config/pid.conf";
#endif
